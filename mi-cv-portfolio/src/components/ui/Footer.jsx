        ...
        <div className="flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="mb-4 md:mb-0">
            <p className="text-slate-600 dark:text-gray-400 text-sm">
              © {new Date().getFullYear()} Julio Marquinez. Todos los derechos reservados.
            </p>
          </div>
          ...
          <div className="flex space-x-6">
            ...
            {/* GitHub */}
            <a 
              href="https://github.com/AgusCuculich" 
              target="_blank" 
            ...
            {/* LinkedIn */}
            <a 
              href="#" // Agrega tu link de LinkedIn aquí cuando quieras
              target="_blank" 
              rel="noopener noreferrer" 
              className="text-slate-500 hover:text-emerald-600 dark:text-gray-400 dark:hover:text-emerald-400 transition-colors"
            >
